...
use lightning::chain;
use lightning::chain::keysinterface::{BaseSign, InMemorySigner, SignerProvider};
...
impl Channel {
    ...
    // FIXME return just funding sig?
    pub fn sign_channel_announcement_with_funding_key(
        &self,
        announcement: &[u8],
    ) -> (Signature, Signature) {
